...
public interface CarMapper extends OffsetDateTimeMapper {
    ...
    CarToBuyDTO map(final CarToBuy carToBuy);
    ...
    default List<CarHistoryDTO.ServiceRequestDTO> mapServiceRequests(
        ...
        return requests.stream().map(this::mepServiceRequest).toList();
    }
    ...
    CarHistoryDTO.ServiceRequestDTO mepServiceRequest(CarHistory.CarServiceRequest carServiceRequest);
}
